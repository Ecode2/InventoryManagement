...
async function InventoryPage(role) {
    ...
    let add_inventory_btn = role == "admin" ? `
        <button type="button" id="createProductButton" data-modal-toggle="createInventoryModal" class="flex items-center justify-center text-white bg-primary-700 hover:bg-primary-800 focus:ring-4 focus:ring-primary-300 font-medium rounded-lg text-sm px-4 py-2 dark:bg-primary-600 dark:hover:bg-primary-700 focus:outline-none dark:focus:ring-primary-800">
